...
export const CardContainer = () => {
    ...
    <div className={s.cardContainer}>
        ...
        <Card src={bigle} alt='Собака' animalType='Собака' animalName='Халк' color='Бело-коричневый' gender='Самец' age='9 месяцев' price='15000 руб'/>
        ...
        <Card src={humster} alt='Хомяк' animalType='Хомяк' animalName='Леопольд' color='Рыжий' gender='Самец' age='1 месяц' price='1800 руб'/>
